<div id="smallDiv"
	style="width: 3%; float: left; display: none;height:100%;">
	<div style="text-align: center; height: 5%; padding-top: 7px;" class="green-g">
		<a href="#"><img src="images/logo_1.png" /></a>
	</div>
	<div class="list-left"
		style="width: 100%; background: rgb(34, 45, 50);height:95%;">
		<div style="padding: 15px 0 20px 14px;">
